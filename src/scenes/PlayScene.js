...
class PlayScene extends BaseScene{
  ...
  createBird(){
    this.bird = this.physics.add.sprite(this.config.startPosition.x, this.config.startPosition.y, 'bird').setFlipX(true).setScale(3).setOrigin(0,0);
  ...
  createPause(){
    ...
    .setInteractive().setScale(3).setOrigin(1);
  ...
  createScore(){
    ...
    this.scoreText = this.add.text(16,16 , `Score:${0}` , {fontSize : 32 , fillText  :'#000'});
    this.add.text(16,52 , `Best score:${bestScore}` , {fontSize : 18 , fillText : '#000'});
  }
